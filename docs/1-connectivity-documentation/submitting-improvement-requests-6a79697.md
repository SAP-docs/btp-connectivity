<!-- loio6a79697229004082b9aa85f0f41cf055 -->

# Submitting Improvement Requests

You can submit your improvement request for SAP BTP Connectivity. It’s a single central place for all activities related to product improvement requests.
...
4.  Enter the details for the improvement request you want to submit.
    ...
    **IR Category**
    ...
    Select *Connectivity* from the drop-down list.
    ...
    **Tags**
    ...
    Use at least one tag that matches your request.
...
5.  Choose the *Submit* button when you are done.
