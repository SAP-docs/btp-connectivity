          ...
          properties:
            ...
            status:
              ...
              properties:
                ...
                state:
                  description:
                    State signifies current state of Module CR. Value can
...
You may update it to suit to your requirements. To do this, either use *kubectl edit* or create an YAML file containing the transparent proxy custom resource and edit the *spec* section with values according to the [Configuration Guide](configuration-guide-2a22cd7.md).
