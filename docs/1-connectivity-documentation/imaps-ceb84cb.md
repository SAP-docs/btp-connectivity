...
Consume a mail system via IMAPS through the Transparent Proxy for Kubernetes and the Destination service.
...
**Example: Internet IMAPS Mail Destination with OAuth2RefreshToken**
...
**Example: Internet IMAPS Mail Destination with OAuth2AuthorizationCode**
...
**IMAPS Consumption for Authentication Types OAuth2RefreshToken/OAuth2AuthorizationCode - Bash Snippet** 
