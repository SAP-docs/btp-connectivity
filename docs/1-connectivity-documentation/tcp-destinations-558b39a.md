...
The Transparent Proxy performs the SOCKS5 handshake with the Connectivity Proxy to enable the consumption of that \(otherwise complex\) functionality out-of-the-box for the application developer.
